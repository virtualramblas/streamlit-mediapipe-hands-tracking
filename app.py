...
if len(uploaded_files) > 0:
    show_coordinates = st.sidebar.checkbox('Show classification results')
    track_button = st.sidebar.button('Track Hands')
    if track_button:
        annotated_images = track_hands_in_images(uploaded_files, max_num_hands, min_detection_confidence)
